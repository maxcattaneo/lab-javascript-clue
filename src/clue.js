...
function selectRandom(myArray) {
    const rand = Math.random()*myArray.length | 0;
    const randValue = myArray[rand];
    return randValue;
}
...
function pickMystery() {
    ...
    const randomMystery = new Mystery (selectRandom(suspectsArray),selectRandom(weaponsArray),selectRandom(roomsArray));
